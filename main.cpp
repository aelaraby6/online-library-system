            ...
            while (b6)
            {
                ...
                case 1 : // add book to list
                {
                    ...
                    while (b8 )
                    {
                        ...
                        switch (choice8)
                        {
                        case 1 : // assign author to the book
                ...
                break;
                case 2 :// search for a book on system
                {
                    b7 = true ;
                    while (b7)
                    {
                ...
                break;
                case 5 : // get all books from author
                {
                    int ID;
                    cout<<"Enter ID"<<endl;
                    cin >> ID;
